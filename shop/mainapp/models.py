...
class Category(models.Model):
    ...
    slug = models.SlugField(unique=True) # в урле например -categories/notebooks slug = notebooks
...
class Cart(models.Model):
    ...
    total_products = models.PositiveIntegerField(default=0) #количество уникальных продуктов в корзине
    final_price = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Общая цена')
